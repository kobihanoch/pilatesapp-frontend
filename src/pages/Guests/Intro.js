      ...
      <section id="קצת עליי" className="aboutme-section">
        ...
        <div className="aboutme-block left">
          ...
          <div className="bubble-text">
            ...
            מדיטציות,מתרגלת מיינדפולנס ומעבירה שיעורים פרטיים ובקב.אני עובדת
            מתוך אהבה עמוקה לעולם התנועה והריפוי ומלווה לאורך הדרך נשים וגברים
            בתהליכי שינוי חיבור וצמיחה.
          </div>
        </div>
        ...
        <div className="aboutme-block left">
          ...
          <div className="bubble-text">
            ...
            פנימית עדינה, המאפשרים תהליך של שינוי, ריפוי והתחדשות עם מטרה של
            טיפוח החיבור הין הגוף לנפש.
          </div>
        </div>
      </section>
